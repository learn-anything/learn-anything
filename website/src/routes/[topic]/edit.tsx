    ...
    display: flex
      ...
      <div class="w-screen h-full text-black bg-white dark:bg-neutral-900">
        ...
        <div class="h-full w-full flex justify-center">
          <div
            id="InfoMain"
            class="h-full bg-white overflow-hidden border-r-[0.5px] border-[#69696951] dark:bg-neutral-900 w-full min-h-screen flex  gap-6 flex-col"
            style={{ padding: "24px 24px 24px 24px" }}
          >
            <GuideEdit />
          </div>
          <div id="InfoSidebar" class="h-full min-h-screen w-[30%]">
