...
export default function Sidebar() {
  ...
  return (
    <>
      <div
        class=" flex h-full border-r-2 border-slate-100 border-opacity-10"
        id="Sidebar"
        style={{ width: "25%", "min-width": "250px" }}
      >
        <div class="flex w-18 dark:bg-[#222222] bg-zinc-200 flex-col justify-between items-center font-semibold p-2 py-4 border-r-2 border-opacity-10 border-slate-100">
        ...
        <div
          id="ContentSidebar"
          class="dark:bg-[#222222] bg-zinc-200 w-full overflow-auto"
        >
          <div
